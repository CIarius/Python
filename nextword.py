...
Author  Rab McC
Date    23/08/20
Details For given text build a dictionary of words and for each a list of any
        subsequent words in the same sentence in descending order of occurance
        such that the first word in each list is word's most common next word.
...
# these three texts between them provide a dictionary of some 40,000 words
